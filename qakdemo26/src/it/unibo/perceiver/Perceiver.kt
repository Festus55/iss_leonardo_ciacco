		...
		return { //this:ActionBasciFsm
				...
				state("waitForEvents") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t04",targetState="handleEvent",cond=whenEvent("alarm"))
				}	 
				state("handleEvent") { //this:State
					action { //it:State
						...
						CommUtils.outmagenta("perceiver ENDS THE SYSTEM")
						//genTimer( actor, state )
					}
					//After Lenzi Aug2002
					sysaction { //it:State
